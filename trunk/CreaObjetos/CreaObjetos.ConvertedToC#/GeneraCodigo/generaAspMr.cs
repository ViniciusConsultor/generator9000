...
namespace WindowsApplication1
{
	public class generaAspMr
	{
		...
		{
			string codigo = null;
			codigo = "Imports System.Data" + Constants.vbCrLf;
			codigo += "Imports " + this.neimespeis + "." + this.neimespeis + Constants.vbCrLf;
			codigo += "Namespace " + this.neimespeis + Constants.vbCrLf;
			...
			codigo += "Partial Class " + this.clace.NombreTabla + Constants.vbCrLf;
			codigo += "Inherits System.Web.UI.Page" + Constants.vbCrLf;
			codigo += "#Region \" Web Form Designer Generated Code \"" + Constants.vbCrLf;
			codigo += "'This call is required by the Web Form Designer." + Constants.vbCrLf;
			codigo += "<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()" + Constants.vbCrLf;

			codigo += "End Function" + Constants.vbCrLf;

			codigo += "Private Sub Page_Init(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Init" + Constants.vbCrLf;
			codigo += "'CODEGEN: This method call is required by the Web Form Designer" + Constants.vbCrLf;
			codigo += "'Do not modify it using the code editor." + Constants.vbCrLf;
			codigo += "InitializeComponent()" + Constants.vbCrLf;
			codigo += "End Function" + Constants.vbCrLf;
